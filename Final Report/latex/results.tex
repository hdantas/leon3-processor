...
consumption is almost proportional to the clock frequency, therefore we can use this value to estimate the
...
\begin{table}[H]
\centering
\begin{tabular}{lccc>{\color{white}\columncolor{Cyan}}c}
\bottomrule
